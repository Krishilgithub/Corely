    ...
    <footer className="footer">
      <div className="footer-content">
        ...
        <div className="footer-brand">
          ...
          <p className="footer-desc">
            The enterprise intelligence platform that unifies your data, automates your workflows, and accelerates your business.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="footer-links">
            ...
            <li><Link href="#" className="footer-link">Community</Link></li>
            <li><Link href="#" className="footer-link">Help Center</Link></li>
            <li><Link href="#" className="footer-link">API Reference</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="footer-links">
            ...
            <li><Link href="#" className="footer-link">Contact Sales</Link></li>
      ...
      <div className="footer-bottom">
        <div className="footer-copyright">
          &copy; {new Date().getFullYear()} Corely Inc. All rights reserved.
        </div>
